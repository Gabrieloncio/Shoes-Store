...
const FavouriteSection = () => {
  ...
  return (
    <div
      className={`w-5/6 md:w-1/2 xl:w-1/4 absolute h-screen bg-white text-black duration-300 top-0 p-4 flex flex-col justify-between items-center border-l-2 border-black ${
